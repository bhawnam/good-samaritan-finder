  ...
  return (
      <div>
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Good Samaritan Finder.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Good Samaritan Finder, accessible from <a href="http://www.goodsamaritanfinder.org" rel="external nofollow noopener" target="_blank">http://www.goodsamaritanfinder.org</a></p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: goodsamaritanfinder@gmail.com</p>
          </li>
          <li>
            <p>By visiting this page on our website: <a href="http://www.goodsamaritanfinder.org/contact-us" rel="external nofollow noopener" target="_blank">http://www.goodsamaritanfinder.org/contact-us</a></p>
          </li>
        </ul>
      </div>
  );
...
function Footer() {
  ...
  return (
      <div>
        ...
        <div>
          <ReactRouterDOM.Link
              to="/terms-of-service" className="foot-link terms">
...
function UserProfile(props){
  ...
  for (const currentFulfilledRequest of Object.values(fulfilledRequests)){
    const requestFeedbackCard = (
      ...
      disableBtn={disable}
      // feedbackRequestForm={feedbackForm}
      // handleFeedbackResponseForm={handleFeedbackResponse}
...
function RequestFeedback(props){
  ...
  // const {request_id, handleRequestFeedbackBtn, service_type, disableBtn, feedbackRequestForm, handleFeedbackResponseForm, feedbackMessage} = props;
  return (
    <React.Fragment>
    <tr key = {request_id}>
    <td>{request_id}</td>
