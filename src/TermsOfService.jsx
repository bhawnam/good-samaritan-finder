  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Good Samaritan Finder.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Good Samaritan Finder, accessible
            from{" "}
            <a
              href="http://www.goodsamaritanfinder.org"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              http://www.goodsamaritanfinder.org
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        dealing, course of performance, usage or trade practice. Without Without
        ...
        <li>
          <p>
            ...
            <a
              ...
              target="_blank"
            >
              http://www.goodsamaritanfinder.org/get-in-touch
            </a>
          </p>
        </li>
      </ul>
